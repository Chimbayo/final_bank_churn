...
// This script handles the churn count display on the main page
// It fetches the predicted churn count from the API and updates the display
document.addEventListener("DOMContentLoaded", function () {
    function fetchChurnCount() {
    ...
    setInterval(fetchChurnCount, 5000);
});
